...
class DeeplinkWrapper extends PureComponent {
    componentDidMount() {
        ...
        // If the current url path is /transition..., meaning it is opened from oldDot, during this transition period:
        ...
        // So we need to wait until after sign-in and navigation are complete before starting the deeplink.
